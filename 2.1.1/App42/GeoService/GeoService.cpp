...
void GeoService::CreateGeoPoints(const char *geoStorageName, vector<App42GeoPoint> geoPointsList, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
     ...
     */
    Util::executePost(encodedUrl, headers, createGeoPointsbody.c_str(), response, app42response_selector(App42GeoResponse::onComplete));
}


void GeoService::GetNearByPointsByMaxDistance(const char *geoStorageName,double lat, double lng, double distanceInKM, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
     ...
     * Initiating Http call
     */
    Util::executeGet(encodedUrl, headers, response, app42response_selector(App42GeoResponse::onComplete));
}

void GeoService::GetNearByPoint(const char *geoStorageName,double lat, double lng, int resultLimit, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
...
void GeoService::GetPointsWithInCircle(const char *geoStorageName,double lat, double lng, double radiusInKM, int resultLimit, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
...
void GeoService::GetAllStorage(App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
...
void GeoService::GetAllStorageByPaging(int max, int offset, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
...
void GeoService::DeleteGeoPoints(const char *geoStorageName, vector<App42GeoPoint> geoPointsList, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
     ...
     * Initiating Http call
     */
    Util::executeDelete(encodedUrl, headers, response, app42response_selector(App42GeoResponse::onComplete));
}

void GeoService::DeleteStorage(const char *geoStorageName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
...
void GeoService::GetAllPoints(const char *geoStorageName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
...
void GeoService::GetAllPointsByPaging(const char *geoStorageName, int max, int offset, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GeoResponse *response = new App42GeoResponse(pTarget,pSelector);
    try
    {
