...
public:
     ...
     * @return void
     */
    void CreateGeoPoints(const char *geoStorageName, vector<App42GeoPoint> geoPointsList, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     * 
     */
    void GetNearByPointsByMaxDistance(const char *geoStorageName,double lat, double lng, double distanceInKM, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void GetNearByPoint(const char *geoStorageName,double lat, double lng, int resultLimit, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void GetPointsWithInCircle(const char *geoStorageName,double lat, double lng, double radiusInKM, int resultLimit, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     * 
     */
    void GetAllStorage(App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void GetAllStorageByPaging(int max, int offset, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    
    void DeleteGeoPoints(const char *geoStorageName, vector<App42GeoPoint> geoPointsList, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);

    void DeleteStorage(const char *geoStorageName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    
    void GetAllPoints(const char *geoStorageName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    
    void GetAllPointsByPaging(const char *geoStorageName, int max, int offset, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
};
